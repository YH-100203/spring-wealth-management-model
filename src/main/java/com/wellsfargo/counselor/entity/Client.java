...
public class Client {
    ...
    @ManyToOne // Annotation to tell JPA that Many clients belong to One advisor
    @JoinColumn(name = "advisorId", nullable = false) // Creates a foreign key column to the Advisor table
